...
select.samples <- all.samples[J(c("mRNA_30cpc_SN","mRNA_30cpc_Th","mRNA_30cpc_Ctx","mRNA_3cpc_SN","mRNA_3cpc_Th","mRNA_3cpc_Ctx","mRNA_30cpc_SN_4wks","mRNA_30cpc_Th_4wks","mRNA_30cpc_Ctx_4wks","mRNA_3cpc_SN_4wks","mRNA_3cpc_Th_4wks","mRNA_3cpc_Ctx_4wks","mRNA_30cpc_Organoid_MD114","mRNA_3000cpc_Organoid_MD101"))] 
...
write.fasta(as.list(select.samples.trsp$Peptide), fasta.names, "data/organoidSamplesPeptides.fasta", open = "w", nbchar = 60, as.string = TRUE)
...
unlink("/home/rstudio/data/HammockOrganoidAll", recursive = TRUE, force = FALSE)
sys.out <-  system(paste("java -jar /home/rstudio/Hammock_v_1.2.0/dist/Hammock.jar full -i /home/rstudio/data/organoidSamplesPeptides.fasta -d /home/rstudio/data/HammockOrganoidAll --max_shift 7 -c 65 -t ", detectCores(), sep = ""),
...
hammock.log <- data.table(readLines("data/HammockOrganoidAll/run.log"))
...
#'===================
ham.clusters <- data.table(read.table("/home/rstudio/data/HammockOrganoidAll/final_clusters.tsv", header = TRUE, skip = 0, sep="\t",
                                      stringsAsFactors = FALSE, fill=TRUE))
id.order <- as.list(ham.clusters$cluster_id)
ham.clusters.all <- data.table(read.table("/home/rstudio/data/HammockOrganoidAll/final_clusters_sequences.tsv", header = TRUE, skip = 0, sep="\t",
                                          stringsAsFactors = FALSE, fill=TRUE))
...
dir.create(file.path("/home/rstudio/data/HammockOrganoidAll/", "alignments_final_Scored"), showWarnings = FALSE)
...
generateWeblogo <- function(in.name) {
  ...
  # in.name <- 6777
  this.fa <- read.fasta(file = paste("/home/rstudio/data/HammockOrganoidAll/alignments_final/", in.name, ".aln", sep=""))
  ...
  write.fasta(as.list(allSeqs.out$Alignment), allSeqs.out$Annot, nbchar = 60, paste("/home/rstudio/data/HammockOrganoidAll/alignments_final_Scored/", in.name, ".aln", sep=""), open = "w")
  ...
  tmp <- system(paste("weblogo --format PDF --sequence-type protein --size large --errorbars NO --resolution 299 --composition equiprobable --color-scheme chemistry --title '",this.title,"' < /home/rstudio/data/HammockOrganoidAll/alignments_final_Scored/", in.name, ".aln > /home/rstudio/data/WEBlogos/",in.name,".pdf", sep = ""),
