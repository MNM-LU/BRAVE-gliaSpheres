...
sys.out <-  system(paste("java -jar /home/rstudio/Hammock_v_1.2.0/dist/Hammock.jar full -i /home/rstudio/data/trspSamplesPeptides.fasta -d /home/rstudio/data/Hammock --max_shift 7 -c 65 -t ", detectCores(), sep = ""),
